...
*   **Cenários**: Validar o fluxo completo de busca de dados no banco PostgreSQL Supabase, a composição do payload enviado ao mock do Gemini e a recepção da resposta final estruturada in JSON, respondendo com status 200 OK.
